...
class Game12Bread {
    ...
    loadImages() {
        return new Promise((resolve) => {
            ...
            const toLoad = [
                ...
                { name: 'tvBackgroundFail', src: 'assets/Ally2_cake/ally2_resourceTV/Ally2_cake_tv_plate_bg2.png' },
    ...
    renderTV() {
        ...
        let bg = this.images.tvBackground;
        if (this.failed && this.images.tvBackgroundFail) {
            bg = this.images.tvBackgroundFail;
        }

        if (bg) {
            this.tvCtx.drawImage(bg, 0, 0, width, height);
        }
    ...
    fail() {
        ...
        this.renderTV(); // Update TV to show fail background
